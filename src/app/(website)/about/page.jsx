...
const page = () => {
  return (
    ...
    <p className="text-gray-600 text-center md:max-w-2xl">
      Tired of juggling a dozen social media and professional links? We get it. That's why
      we built LinkFree, your one-stop shop for showcasing your entire digital presence.
    </p>
